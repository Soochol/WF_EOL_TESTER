...
Public Const AXT_SMC_R1V04MLIIIAZ = &H27                    ' DSP, 4 Axis, For ML-3 AZD/ORIENTAL only (Multi-Axis Control amp)
Public Const AXT_SMC_R1V04MLIIIPCON = &H28                  ' DSP, 1 Axis, For ML-3 PCON/IAI only
Public Const AXT_SMC_R1V04MLIIIVPH_HE = &H29                ' DSP, 1 Axis, For ML-3 VPH-HE/NIKKIDENSO only
