...
Base classes for command and result objects used across all use cases.
...
class BaseCommand(ABC):
    """
    Abstract base class for all use case commands
    
    Commands encapsulate input parameters for use case execution.
