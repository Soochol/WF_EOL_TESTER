...
class ApplicationContainer(containers.DeclarativeContainer):
    ...
    @classmethod
    def ensure_config_exists(cls, config_path: str = "configuration/application.yaml") -> None:
        """
        ...
        try:
            ...
            # Get template path
            template_path = Path(__file__).parent.parent / "templates" / "default_application.yaml"
...
"""
    ...
    @classmethod
    def load_config_safely(cls, config_path: str = "configuration/application.yaml") -> 'ApplicationContainer':
        """
    ...
    def _apply_fallback_config(cls, container: 'ApplicationContainer') -> None:
        ...
        container.config.from_dict({
            ...
            "hardware": {
                "robot": {"model": "mock", "axis_id": 0, "irq_no": 7},
                "power": {"model": "mock", "host": "localhost", "port": 8080, "channel": 1, "timeout": 10.0},
                "mcu": {"model": "mock", "port": "COM3", "baudrate": 115200, "timeout": 5.0, "bytesize": 8, "stopbits": 1, "parity": None},
                "loadcell": {"model": "mock", "port": "COM4", "baudrate": 9600, "timeout": 3.0, "bytesize": 8, "stopbits": 1, "parity": None, "indicator_id": 1},
                "digital_io": {"model": "mock"}
            },
            "services": {
                "repository": {"results_path": "ResultsLog", "auto_save": True}
            },
            "logging": {"level": "INFO"}
        })
    ...
    # Hardware container
    hardware = providers.Container(HardwareContainer, config=config.hardware)
    ...
    # Repository and utility services
    ...
    robot_home_use_case = providers.Factory(
        RobotHomeUseCase,
        hardware_services=hardware_service_facade,
        hardware_config=providers.Callable(
            lambda cs: cs.load_hardware_config(), cs=configuration_service
        ),
    )
