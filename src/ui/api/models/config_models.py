...
class ConfigurationResponse(BaseModel):
    ...
    hardware_configuration: Dict[str, Any] = Field(
...
class ConfigurationUpdateRequest(BaseModel):
    ...
    test_configuration: Optional[Dict[str, Any]] = Field(
        None, description="Test configuration updates"
    )
    hardware_configuration: Optional[Dict[str, Any]] = Field(
        None, description="Hardware configuration updates"
    )
    metadata: Optional[Dict[str, Any]] = Field(None, description="Configuration metadata")
...
class ConfigurationValidationRequest(BaseModel):
    ...
    config_type: str = Field(
        ..., description="Type of configuration (test_profile, dut_defaults, etc.)"
    )
