...
from ..models.hardware_models import HardwareStatus, HardwareCommand, HardwareConfig
...
class HardwareController:
    ...
    async def execute_hardware_command(self, component: str, command: HardwareCommand) -> Dict[str, Any]:
