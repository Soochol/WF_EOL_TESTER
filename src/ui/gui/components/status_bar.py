...
from PySide6.QtWidgets import (
    QStatusBar, QWidget, QHBoxLayout, QLabel, QFrame, 
...
from ui.gui.services.gui_state_manager import GUIStateManager, ConnectionStatus
...
class StatusBarWidget(QStatusBar):
    ...
    def update_hardware_status(self, hardware_status) -> None:
        ...
        if self.connection_section:
            connected_count = sum(1 for status in [
