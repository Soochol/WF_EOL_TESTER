...
class ContentAreaWidget(QWidget):
    ...
    def initialize_panels(self) -> None:
        ...
        try:
            ...
            self.add_panel("eol_test", eol_test_panel, "EOL Force Test", "End-of-Line Force Testing")
            ...
            self.add_panel("mcu_test", mcu_test_panel, "Simple MCU Test", "Basic MCU Communication Test")
            ...
            self.add_panel("hardware", hardware_panel, "Hardware Control", "Manual Hardware Operations")
