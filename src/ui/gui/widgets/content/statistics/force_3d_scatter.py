"""Force 3D Scatter Plot Panel

3D scatter plot showing individual force measurements across temperature and position.
"""
...
class Force3DScatter(QWidget):
    """3D scatter plot panel showing individual force measurements.
    ...
    def setup_ui(self) -> None:
        """Setup the 3D scatter plot UI."""
        main_layout = QVBoxLayout(self)
        main_layout.setSpacing(12)
        main_layout.setContentsMargins(10, 10, 10, 10)

        # Title
        title_label = QLabel("3D Scatter Plot: Individual Force Measurements")
        title_font = QFont()
        ...
        # Description
        desc_label = QLabel(
            "Each point represents an individual force measurement at specific temperature and position"
        )
    ...
    def update_scatter(self, scatter_data: List[Dict[str, Any]]) -> None:
        ...
        self.ax.set_title(
            "Force Measurements: Temperature × Position", fontsize=12, color="#ffffff", pad=20
        )
