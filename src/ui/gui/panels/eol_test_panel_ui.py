...
class Ui_EOLTestPanel(object):
    def setupUi(self, EOLTestPanel):
        if not EOLTestPanel.objectName():
            EOLTestPanel.setObjectName("EOLTestPanel")
        ...
        self.buttonSpacer1 = QSpacerItem(
        ...
        self.buttonSpacer2 = QSpacerItem(
            20, 8, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Fixed
        )
        ...
        self.controlVerticalSpacer = QSpacerItem(
        ...
        self.testLogText.setObjectName("testLogText")
    ...
    def retranslateUi(self, EOLTestPanel):
        EOLTestPanel.setWindowTitle(
            QCoreApplication.translate("EOLTestPanel", "EOL Test Panel", None)
        )
        self.controlGroup.setTitle(QCoreApplication.translate("EOLTestPanel", "Test Control", None))
        ...
        self.startTestButton.setText(
            QCoreApplication.translate("EOLTestPanel", "Start EOL Test", None)
        )
        ...
        self.stopTestButton.setText(QCoreApplication.translate("EOLTestPanel", "Stop Test", None))
        ...
        self.resetButton.setText(QCoreApplication.translate("EOLTestPanel", "Reset", None))
        ...
        self.resultsGroup.setTitle(QCoreApplication.translate("EOLTestPanel", "Test Results", None))
        self.resultsGroup.setStyleSheet(
            QCoreApplication.translate(
                "EOLTestPanel",
                "QGroupBox {\n"
                "    font-weight: bold;\n"
        ...
        self.summaryLabel.setText(
            QCoreApplication.translate("EOLTestPanel", "No test results available", None)
        )
        ...
        self.progressGroup.setTitle(
            QCoreApplication.translate("EOLTestPanel", "Test Progress", None)
        )
        self.progressGroup.setStyleSheet(
            QCoreApplication.translate(
                "EOLTestPanel",
                "QGroupBox {\n"
                "    font-weight: bold;\n"
        ...
        self.statusLabel.setText(
            QCoreApplication.translate("EOLTestPanel", "Ready to start test", None)
        )
        self.statusLabel.setStyleSheet(
            QCoreApplication.translate(
                "EOLTestPanel", "color: #2C3E50; padding: 4px; font-size: 11px;", None
            )
        )
        ...
        self.logGroup.setTitle(QCoreApplication.translate("EOLTestPanel", "Test Log", None))
        ...
        self.testLogText.setStyleSheet(
            QCoreApplication.translate(
                "EOLTestPanel",
                "QTextEdit {\n"
