        ...
        self.categories = {
            ...
            SettingsCategory.TESTING.value: [
                ...
                FormField(
                    ...
                    required=True,
                    validation_rules=[
                        {"rule": "range", "min": 1, "max": 100, "message": "Samples must be between 1-100"}
                    ]
                ),
                FormField(
                    name="retry_attempts",
                    ...
                    validation_rules=[
                        {"rule": "range", "min": 0, "max": 10, "message": "Retries must be between 0-10"}
                    ]
                ),
                FormField(
            ...
            SettingsCategory.UI_PREFERENCES.value: [
                ...
                FormField(
                    ...
                    validation_rules=[
                        {"rule": "range", "min": 1, "max": 60, "message": "Interval must be between 1-60 seconds"}
                    ]
                )
            ]
        }
    ...
    def set_field_value(self, field_name: str, value: Any, validate: bool = True) -> bool:
        ...
        if validate:
            ...
            self._validation_errors = [
                err for err in self._validation_errors 
