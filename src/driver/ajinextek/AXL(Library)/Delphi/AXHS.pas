...
const
    ...
    AXT_SMC_R1V04MLIIIAZ                = $27;          // DSP, 4 Axis, For ML-3 AZD/ORIENTAL only (Multi-Axis Control amp)
    AXT_SMC_R1V04MLIIIPCON              = $28;          // DSP, 1 Axis, For ML-3 PCON/IAI only
    AXT_SMC_R1V04MLIIIVPH_HE            = $29;          // DSP, 1 Axis, For ML-3 VPH-HE/NIKKIDENSO only	
