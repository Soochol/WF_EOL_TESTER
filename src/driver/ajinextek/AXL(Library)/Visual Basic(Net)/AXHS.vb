...
Module AXHS
    ...
    Public Const AXT_SMC_R1V04MLIIIAZ As Short = &H27S                      ' DSP, 4 Axis, For ML-3 AZD/ORIENTAL only (Multi-Axis Control amp)
    Public Const AXT_SMC_R1V04MLIIIPCON As Short = &H28S                    ' DSP, 1 Axis, For ML-3 PCON/IAI only
    Public Const AXT_SMC_R1V04MLIIIVPH_HE As Short = &H29S                  ' DSP, 1 Axis, For ML-3 VPH-HE/NIKKIDENSO only
