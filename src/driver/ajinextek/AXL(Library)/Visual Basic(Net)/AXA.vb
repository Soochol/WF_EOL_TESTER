...
Module AXA
    ...
    '==================================================================================================
    Public Declare Function AxaiSetRangeModule Lib "AXL.dll" (ByVal lModuleNo As Integer, ByVal dMinVolt As Double, ByVal dMaxVolt As Double) As Integer
    ...
    ' *dMaxVolt   : +5V, +10V
    '==================================================================================================
    Public Declare Function AxaiGetRangeModule Lib "AXL.dll" (ByVal lModuleNo As Integer, ByRef dMinVolt As Double, ByRef dMaxVolt As Double) As Integer
    ...
    Public Declare Function AxaiHwReadSampleVoltage Lib "AXL.dll" (ByVal lChannelNo As Integer, ByRef lpSize As Integer, ByRef dpVolt As Double) As Integer

    '지정한 입력 채널에 H/W타이머를 이용하여 A/D변환된 값을 Digit 값으로 읽는다.
    Public Declare Function AxaiHwReadSampleDigit Lib "AXL.dll" (ByVal lChannelNo As Integer, ByRef lpsize As Integer, ByRef upDigit As Integer) As Integer
    ...
    '                 : FIFO_DATA_FULL(6)
    '==================================================================================================
    Public Declare Function AxaiExternalReadFifoStatus Lib "AXL.dll" (ByVal lModuleNo As Integer, ByRef dwpStatus As Integer) As Integer
    ...
    '지정한 출력 채널에 입력된 전압이 출력 된다.
    Public Declare Function AxaoWriteDigit Lib "AXL.dll" (ByVal lChannelNo As Integer, ByVal dwDigit As Integer) As Integer

    '지정한 여러 출력 채널에 입력된 전압이 출력 된다.
    Public Declare Function AxaoWriteMultiDigit Lib "AXL.dll" (ByVal lSize As Integer, ByRef lpChannelNo As Integer, ByRef dpDigit As Integer) As Integer
    ...
    '지정한 출력 채널에 출력되는 전압 값을 확인한다.
    Public Declare Function AxaoReadDigit Lib "AXL.dll" (ByVal lChannelNo As Integer, ByRef upDigit As Integer) As Integer

    '지정한 여러 출력 채널에 출력되는 전압 값을 확인한다.
    Public Declare Function AxaoReadMultiDigit Lib "AXL.dll" (ByVal lSize As Integer, ByRef lpChannelNo As Integer, ByRef dpDigit As Integer) As Integer
    ...
    Public Declare Function AxaoPgSetUserPatternGeneratorDigit Lib "AXL.dll" (ByVal lChannelNo As Integer, ByVal lLoopCnt As Integer, ByVal lPatternSize As Integer, ByRef pDigitPattern As Integer) As Integer
    ...
    Public Declare Function AxaoPgGetUserPatternGeneratorDigit Lib "AXL.dll" (ByVal lChannelNo As Integer, ByRef lpLoopCnt As Integer, ByRef lpPatternSize As Integer, ByRef pDigitPattern As Integer) As Integer
    ...
    Public Declare Function AxaoPgSetUserStart Lib "AXL.dll" (ByRef lpChannelNo As Integer, ByVal lSize As Integer) As Integer
