...
class ServicesConfigPaths:
    ...
    repository_raw_data_path: str = "Logs/measurements/raw_data"
    repository_summary_path: str = "Logs/measurements"
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ApplicationConfig":
        ...
        return cls(
            ...
            services=ServicesConfigPaths(
                ...
                repository_raw_data_path=services_data.get("repository", {}).get("raw_data_path", "Logs/measurements/raw_data"),
                repository_summary_path=services_data.get("repository", {}).get("summary_path", "Logs/measurements"),
                repository_summary_filename=services_data.get("repository", {}).get("summary_filename", "test_summary.csv"),
                repository_auto_save=services_data.get("repository", {}).get("auto_save", True),
                config_application_path=services_data.get("configuration", {}).get("application_path", "configuration/application.yaml"),
                config_hardware_path=services_data.get("configuration", {}).get("hardware_path", "configuration/hardware_config.yaml"),
                config_profile_preference_path=services_data.get("configuration", {}).get("profile_preference_path", "configuration/profile_preferences.json"),
                config_test_profiles_dir=services_data.get("configuration", {}).get("test_profiles_dir", "configuration/test_profiles"),
                config_heating_cooling_path=services_data.get("configuration", {}).get("heating_cooling_path", "configuration/heating_cooling_time_test.yaml")
            ),
