...
class EOLTestResult:
    ...
    # MEASUREMENT DATA
    # ========================================================================
    measurement_ids: List[MeasurementId] = None          # Individual measurement IDs
    test_summary: Union[TestMeasurements, Dict[str, Any]] = None  # Measurement data
    ...
    def _validate_test_data_consistency(self) -> None:
        ...
        if (self.test_status == TestStatus.COMPLETED and 
            not self.measurement_ids and 
            self.test_summary is None):
            raise ValidationException(
                "measurements",
                None,
    ...
    def has_measurements(self) -> bool:
        ...
        """
        return (self.measurement_count > 0 or 
                self.test_summary is not None)
    ...
    @classmethod
    def create_success(cls, test_id: TestId, is_passed: bool, 
                      ...
                      notes: Optional[str] = None) -> "EOLTestResult":
    ...
    @classmethod
    def create_error(cls, test_id: TestId, error_message: str,
                    duration: Optional[TestDuration] = None) -> "EOLTestResult":
    ...
    @classmethod
    def create_cancelled(cls, test_id: TestId, reason: Optional[str] = None,
                        duration: Optional[TestDuration] = None) -> "EOLTestResult":
    ...
    def __str__(self) -> str:
        ...
        measurement_info = f", {self.measurement_count} measurements" if self.has_measurements else ""
