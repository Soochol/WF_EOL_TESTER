...
class Timestamp:
    ...
    def __eq__(self, other) -> bool:
        if not isinstance(other, Timestamp):
            return False
        return (
            abs(self._timestamp - other._timestamp) < 1e-6
    ...
    def __lt__(self, other) -> bool:
        if not isinstance(other, Timestamp):
            raise TypeError(
                f"Cannot compare Timestamp with {type(other).__name__}"
            )
...
class TestDuration:
    ...
    def from_milliseconds(
        cls, milliseconds: Union[int, float]
    ) -> "TestDuration":
    ...
    def between_timestamps(
        cls, start: Timestamp, end: Timestamp
    ) -> "TestDuration":
    ...
    def __lt__(self, other) -> bool:
        if not isinstance(other, TestDuration):
            raise TypeError(
                f"Cannot compare TestDuration with {type(other).__name__}"
            )
    ...
    def __add__(self, other) -> "TestDuration":
        if not isinstance(other, TestDuration):
            raise TypeError(
                f"Cannot add TestDuration with {type(other).__name__}"
            )
    ...
    def __sub__(self, other) -> "TestDuration":
        if not isinstance(other, TestDuration):
            raise TypeError(
                f"Cannot subtract {type(other).__name__} from TestDuration"
            )
