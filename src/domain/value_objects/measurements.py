...
class MeasurementReading:
    ...
    @classmethod
    def create_now(
        cls, force: float, unit: MeasurementUnit = MeasurementUnit.KILOGRAM_FORCE
    ) -> "MeasurementReading":
...
class TestMeasurements:
    ...
    def is_complete_matrix(
        self, expected_temperatures: List[float], expected_positions: List[float]
    ) -> bool:
