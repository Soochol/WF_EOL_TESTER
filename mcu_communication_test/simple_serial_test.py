        ...
        for i, cmd in enumerate(test_sequence):
            ...
            if cmd.get("expect_delayed", False):
                ...
                if delayed_result:
                    ...
                    print(f"📥 추가 응답: {delayed_result['rx_packet']} (+{delayed_result['response_time_ms']:.1f}ms)")
    ...
    def save_results(self, filename: str = None):
        ...
        results_data = {
            ...
            "summary": {
                ...
                "avg_response_time": sum([r.get("response_time_ms", 0) for r in self.test_results if r.get("success", False)]) / max(1, len([r for r in self.test_results if r.get("success", False)]))
            }
        }
