    ...
    async def start_standby_heating(
        ...
        try:
            ...
            response = await self._send_packet(
                packet, 
                f"CMD_LMA_INIT (동작:{operating_temp}°C, 대기:{standby_temp}°C)"
            )
    ...
    async def run_performance_test(self) -> bool:
        ...
        try:
            ...
            commands = [
                ...
                ("start_standby_heating", lambda: self.fast_mcu.start_standby_heating(52.0, 35.0, 10000)),
